...
rh.consts('HELP_ID', 'de910c99-b11d-4231-872f-9787641e9708' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "SpecsIntact Help");
model.publish(rh.consts('PDF_FILE_NAME'), "");
model.publish(rh.consts('MAX_SEARCH_RESULTS'), "20");
model.publish(rh.consts('KEY_SKIN_FOLDER_NAME'), "Azure_SI5");
